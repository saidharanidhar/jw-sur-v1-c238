...
class GeoLite(Schema):
    ...
    latitude = fields.String(data_key="geoplugin_latitude", allow_none=True)
    timezone = fields.String(data_key="geoplugin_timezone", allow_none=True)
    longitude = fields.String(data_key="geoplugin_longitude", allow_none=True)
